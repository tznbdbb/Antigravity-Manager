...
function Settings() {
  ...
  const { config, loadConfig, saveConfig, updateLanguage, updateTheme } =
    useConfigStore();
  const { enable, disable, isEnabled } = useDebugConsole();
  const [activeTab, setActiveTab] = useState<
    "general" | "account" | "proxy" | "advanced" | "debug" | "about"
  >("general");
  ...
  useEffect(() => {
    ...
    if (isTauri()) {
      invoke<boolean>("check_homebrew_installation")
        ...
        .catch((err) =>
          console.error("Failed to check Homebrew installation:", err),
        );
    }
  }, [loadConfig]);
  ...
  const handleDetectAntigravityPath = async () => {
    try {
      const command = isTauri()
        ? "get_antigravity_path"
        : "get_antigravity_path"; // 后端已统一
  ...
  const handleCheckUpdate = async () => {
    ...
    try {
      ...
      if (result.has_update) {
        const sourceMsg =
          result.source && result.source !== "GitHub API"
            ? ` (via ${result.source})`
            : "";
        showToast(
  ...
  const handleBrewUpgrade = async () => {
    ...
    try {
      ...
      const errMsg = t(
        `settings.about.brew_error_${errKey}`,
        t("settings.about.brew_upgrade_failed"),
      );
  ...
  const confirmClearAntigravityCache = async () => {
    ...
    try {
      ...
      if (result.cleared_paths.length > 0) {
        showToast(
          t("settings.advanced.cache_cleared_success", { size: sizeMB }),
          "success",
        );
    ...
    <div className="h-full w-full overflow-y-auto">
      <div className="p-5 space-y-4 max-w-7xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="enabled" disabled={!isTauri()}>
                    {t("settings.general.auto_launch_enabled")}
                  </option>
                </select>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-base-200 rounded-lg border border-gray-100 dark:border-base-300">
                  <div>
                    <div className="font-medium text-gray-900 dark:text-base-content">
                      {t("settings.general.auto_check_update")}
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      {t("settings.general.auto_check_update_desc")}
                    </p>
                  </div>
                    ...
                    <input
                      ...
                      onChange={async (e) => {
                        ...
                        try {
                          await invoke("save_update_settings", {
                            settings: {
                              ...
                              check_interval_hours:
                                formData.update_check_interval ?? 24,
                            },
                          });
                          setFormData({
                            ...formData,
                          ...
                          showToast(
                            enabled
                              ? t("settings.general.auto_check_update_enabled")
                              : t(
                                  "settings.general.auto_check_update_disabled",
                                ),
                            "success",
                          );
                        } catch (error) {
                  ...
                  <div className="ml-4">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          update_check_interval: parseInt(e.target.value),
                        })
                      }
                      onBlur={async () => {
                        try {
                ...
                <div className="border-t border-gray-200 dark:border-base-200 pt-6 mt-6">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                    {[
                      ...
                      {
                        path: "/monitor",
                        label: t("nav.call_records"),
                        icon: Activity,
                      },
                      {
                        path: "/token-stats",
                        label: t("nav.token_stats"),
                        icon: BarChart3,
                      },
                      {
                        path: "/user-token",
                        label: t("nav.user_token", "User Tokens"),
                        icon: Users,
                      },
                      {
                        path: "/security",
                      ...
                      return (
                        ...
                        >
                          ...
                          {isVisible && (
                            <div className="absolute top-2 right-2 text-blue-500">
                              <CheckCircle2
                                size={16}
                                fill="currentColor"
                                className="text-white dark:text-base-100"
                              />
                            </div>
                          )}
                          ...
                          <span
                            className={`font-medium text-sm ${isVisible ? "text-blue-900 dark:text-blue-100" : "text-gray-500"}`}
                          >
                            {item.label}
                          </span>
                        </div>
            ...
            <div className="space-y-4 animate-in fade-in duration-500">
              ...
              <div className="group bg-white dark:bg-base-100 rounded-xl p-5 border border-gray-100 dark:border-base-200 hover:border-blue-200 transition-all duration-300 shadow-sm">
                <div className="flex items-center justify-between">
                  ...
                  <label
                    className={`relative inline-flex items-center ${formData.quota_protection.enabled ? "cursor-not-allowed opacity-80" : "cursor-pointer"}`}
                  >
                    <input
                      type="checkbox"
                      className="sr-only peer"
                    ...
                    />
                    <div
                      className={`w-11 h-6 bg-gray-200 dark:bg-base-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-500 shadow-inner ${formData.quota_protection.enabled ? "peer-checked:bg-blue-500" : ""}`}
                    ></div>
                  </label>
                </div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        // 限制最大值为 35791 (接近32位整型上限的分钟数 ~24天)
                        // 防止 setInterval 溢出变成 0，导致死循环卡死后端
                        if (val > 35791) val = 35791;
                        setFormData({ ...formData, refresh_interval: val });
                      }}
                    />
                  </div>
                </div>
                  ...
                  <div className="mt-5 pt-5 border-t border-gray-50 dark:border-base-300 flex items-center gap-4 animate-in slide-in-from-top-1 duration-200">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (isNaN(val) || val < 1) val = 1;
                        if (val > 35791) val = 35791;
                        setFormData({ ...formData, sync_interval: val });
                      }}
                    />
                  </div>
                )}
          ...
          {activeTab === "advanced" && (
            <>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-4 border border-gray-200 dark:border-base-300 rounded-lg bg-gray-50 dark:bg-base-200 text-gray-900 dark:text-base-content font-medium"
                      value={
                        formData.antigravity_args
                          ? formData.antigravity_args.join(" ")
                          : ""
                      }
                      placeholder={t(
                        "settings.advanced.antigravity_args_placeholder",
                      )}
                      onChange={(e) => {
                        const args =
                          e.target.value.trim() === ""
                    ...
                    <button
                      ...
                      onClick={async () => {
                        try {
                          const args = await invoke<string[]>(
                            "get_antigravity_args",
                          );
                          setFormData({ ...formData, antigravity_args: args });
                          showToast(
                            t("settings.advanced.antigravity_args_detected"),
                            "success",
                          );
                        } catch (error) {
                          showToast(
                            `${t("settings.advanced.antigravity_args_detect_error")}: ${error}`,
                            "error",
                          );
                        }
                      }}
                ...
                <div className="border-t border-gray-200 dark:border-base-200 pt-4">
                  <h3 className="font-medium text-gray-900 dark:text-base-content mb-3">
                    {t("settings.advanced.antigravity_cache_title")}
                  </h3>
                  ...
                  <div className="bg-gray-50 dark:bg-base-200 border border-gray-200 dark:border-base-300 rounded-lg p-3 mb-3">
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      {t("settings.advanced.antigravity_cache_desc")}
                    </p>
                  </div>
                  <div className="flex items-center gap-4">
                    <button
                            ...
                            setFormData({
                              ...
                              proxy: {
                                ...
                                debug_logging: {
                                  ...
                                  output_dir:
                                    formData.proxy?.debug_logging?.output_dir,
                                },
                              },
                            })
                          }
                      ...
                      <>
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                            {t("settings.advanced.debug_log_dir_hint", {
                              path: dataDirPath.replace(/\/$/, ""),
                            })}
                          </p>
                        </div>
                      </>
              ...
              <div className="flex items-center justify-between">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <span className="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300">
                    {isEnabled
                      ? t("settings.debug.enabled")
                      : t("settings.debug.disabled")}
                  </span>
                </label>
              </div>
                    ...
                    <div className="pt-4 border-t border-gray-50 dark:border-base-300">
                      ...
                      <div className="mt-4 bg-amber-50/40 dark:bg-amber-900/10 rounded-xl p-3.5 border border-amber-100/50 dark:border-amber-800/20 text-[11px] text-amber-700 dark:text-amber-400 flex items-start gap-3 transition-colors hover:bg-amber-50/60">
                        ...
                        <div className="leading-relaxed">
                          <span className="font-bold mr-1.5 opacity-80 uppercase tracking-tighter">
                            Tip:
                          </span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 w-full max-w-6xl px-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="font-bold text-gray-900 dark:text-base-content whitespace-nowrap overflow-hidden text-ellipsis w-full">
                        Channel
                      </div>
                    </div>
                  </a>
        ...
        <ModalDialog
          ...
          type="confirm"
          confirmText={
            isClearingCache ? t("common.clearing") : t("common.clear")
          }
          cancelText={t("common.cancel")}
          isDestructive={true}
          ...
          <div className="space-y-3">
            ...
            <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/30 rounded-lg p-3">
              <p className="text-xs text-amber-700 dark:text-amber-400 mb-2">
                {t("settings.about.brew_quarantine_hint")}
              </p>
              <div className="flex items-center justify-between gap-2">
                <code className="text-xs text-amber-800 dark:text-amber-300 break-all">
                  sudo xattr -rd com.apple.quarantine "/Applications/Antigravity
                  Tools.app"
                </code>
                <button
        ...
        {/* Support Modal */}
        <div
          className={`modal ${isSupportModalOpen ? "modal-open" : ""} z-[100]`}
        >
          <div
          ...
          <div className="modal-box relative max-w-2xl bg-white dark:bg-base-100 shadow-2xl rounded-3xl p-0 overflow-hidden transform transition-all animate-in fade-in zoom-in-95 duration-300">
            <div className="flex flex-col items-center p-8">
              ...
              <h3 className="text-2xl font-black text-gray-900 dark:text-base-content mb-3">
                {t("settings.about.support_title")}
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-8">
                ...
                <div className="flex flex-col items-center gap-3 p-4 rounded-2xl bg-gray-50 dark:bg-base-200 border border-gray-100 dark:border-base-300">
                  ...
                  <span className="text-xs font-bold text-gray-700 dark:text-gray-300">
                    {t("settings.about.support_alipay")}
                  </span>
                </div>
                ...
                <div className="flex flex-col items-center gap-3 p-4 rounded-2xl bg-gray-50 dark:bg-base-200 border border-gray-100 dark:border-base-300">
                  <div className="w-full aspect-square relative bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100">
                    <img
                      src="/images/donate/wechat.png"
                      alt="WeChat"
                      className="w-full h-full object-contain"
                    />
                  </div>
                  <span className="text-xs font-bold text-gray-700 dark:text-gray-300">
                    {t("settings.about.support_wechat")}
                  </span>
                </div>
                ...
                <div className="flex flex-col items-center gap-3 p-4 rounded-2xl bg-gray-50 dark:bg-base-200 border border-gray-100 dark:border-base-300">
                  <div className="w-full aspect-square relative bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100">
                    <img
                      src="/images/donate/coffee.png"
                      alt="Buy Me A Coffee"
                      className="w-full h-full object-contain"
                    />
                  </div>
                  <span className="text-xs font-bold text-gray-700 dark:text-gray-300">
                    {t("settings.about.support_buymeacoffee")}
                  </span>
                </div>
              </div>
          ...
          <div
            className="modal-backdrop bg-black/60 backdrop-blur-md fixed inset-0 z-[-1]"
            onClick={() => setIsSupportModalOpen(false)}
          ></div>
        </div>
      </div>
